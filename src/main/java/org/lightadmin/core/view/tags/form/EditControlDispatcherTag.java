...
public class EditControlDispatcherTag extends SimpleTagSupport {
    ...
    private JspFragment textareaEditControl;
    ...
    private void doWithStandardControl() throws JspException, IOException {
        ...
        JspFragment worker;
        System.out.println(persistentProperty);
	...
	public void setTextareaEditControl(JspFragment textareaEditControl) {
		this.textareaEditControl = textareaEditControl;
	}
}
